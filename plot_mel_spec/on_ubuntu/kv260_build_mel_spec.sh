...
$CXX -std=c++17 -O2 -o plot_mel_spec_from_txt_ver3_for_ocean plot_mel_spec_from_txt_ver3_for_ocean.cpp ${CAIRO_FLAGS}

$CXX -std=c++17 -O2 -o plot_mel_spec_from_txt_out_RGB_for_ocean plot_mel_spec_from_txt_out_RGB_for_ocean.cpp 
